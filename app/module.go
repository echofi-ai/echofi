...
func appModules(
	...
	return []module.AppModule{
		...
		auth.NewAppModule(appCodec, app.AppKeepers.AccountKeeper, nil, app.AppKeepers.GetSubspace(authtypes.ModuleName)),
		...
		slashing.NewAppModule(appCodec, app.AppKeepers.SlashingKeeper, app.AppKeepers.AccountKeeper, app.AppKeepers.BankKeeper, app.AppKeepers.StakingKeeper, app.AppKeepers.GetSubspace(slashingtypes.ModuleName), app.interfaceRegistry),
		...
		no_valupdates_staking.NewAppModule(appCodec, app.AppKeepers.StakingKeeper, app.AppKeepers.AccountKeeper, app.AppKeepers.BankKeeper, app.AppKeepers.GetSubspace(stakingtypes.ModuleName)),
		...
		ibcwasm.NewAppModule(app.AppKeepers.WasmClientKeeper),
		sdkparams.NewAppModule(app.AppKeepers.ParamsKeeper), //nolint:staticcheck
		consensus.NewAppModule(appCodec, app.AppKeepers.ConsensusParamsKeeper),
		wasm.NewAppModule(appCodec, &app.AppKeepers.WasmKeeper, app.AppKeepers.StakingKeeper, app.AppKeepers.AccountKeeper, app.AppKeepers.BankKeeper, app.BaseApp.MsgServiceRouter(), app.AppKeepers.GetSubspace(wasmtypes.ModuleName)),
		app.AppKeepers.TransferModule,
		app.AppKeepers.ICAModule,
		app.AppKeepers.PFMRouterModule,
		app.AppKeepers.RateLimitModule,
		app.AppKeepers.ProviderModule,
